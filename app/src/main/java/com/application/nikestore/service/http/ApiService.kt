package com.application.nikestore.service.http

import com.application.nikestore.data.*
...
interface ApiService {
    ...
    fun changeCountItem(@Body jsonObject: JsonObject): Single<AddToCartResponse>
